...
def intersection_over_union(boxes_preds, boxes_labels, box_format = "corner"):
    ...
    if box_format == "center":
        ...
        box2_x1 = boxes_labels[...,0:1] - boxes_labels[...,2:3]
        box2_y1 = boxes_labels[...,1:2] - boxes_labels[...,3:4]
